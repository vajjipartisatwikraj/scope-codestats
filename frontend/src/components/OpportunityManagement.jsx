...
const OpportunityManagement = () => {
  ...
  // LAZY LOAD: Fetch opportunities only on first mount
  useEffect(() => {
    if (!hasLoadedData) {
      fetchOpportunities();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingOpportunity) {
        ...
        await axios.post(`${apiUrl}/admin/opportunities`, submissionData, {
          headers: { Authorization: `Bearer ${token}` },
        });
          ...
          sx={{
            ...
            "& .MuiOutlinedInput-root": {
              ...
              "&:hover": {
                "& > fieldset": {
                  borderColor:
                    theme.palette.mode === "dark" ? "#232323" : "primary.main",
                },
              },
            },
            "& .MuiInputBase-input": {
                ...
                <CardContent sx={{ flexGrow: 1, p: 3 }}>
                  ...
                  >
                    ...
                    <Chip
                      ...
                      size="small"
                      sx={{
                        bgcolor: opportunity.registrationOpen
                          ? "#2ecc71"
                          : "#e74c3c",
                        color: "white",
                      }}
                  ...
                  >
                    ...
                    >
                      {opportunity.organizer ? (
                        opportunity.organizer.charAt(0).toUpperCase()
                      ) : (
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        organizerImageUrl: e.target.value,
                      })
                    }
                    ...
                    <Select
                      ...
                      onChange={(e) => {
                        ...
                        setFormData({
                          ...
                          prize:
                            newCategory === "hackathon" ? formData.prize : "",
                        });
                      }}
                      sx={{ borderRadius: 2 }}
                    >
