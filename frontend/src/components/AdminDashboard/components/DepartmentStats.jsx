...
const DepartmentStats = ({ stats, loading: parentLoading, setLoading: parentSetLoading, setError: parentSetError }) => {
  ...
  return (
    <Grid container spacing={3}>
      ...
      <Grid item xs={12} md={6}>
        <Paper
          sx={{ p: { xs: 2, md: 3 }, borderRadius: 2, height: "100%", backgroundColor: theme.palette.mode === 'dark' ? "#0A0A0A" : "white", border: theme.palette.mode === 'dark' ? "1px solid #232323" : "1px solid rgba(0,0,0,0.1)" }}
        >
